...
- **Anasayfa** — hero with a typing animation, avatar, and social links
- **Ben Kimim** — expandable experience timeline, education, and skill groups, all from one data file
- **Blog** — markdown posts with tags, tag pages, prev/next navigation, reading time, and drafts
- **İletişim** — trip entries with hero images, highlight badges, photo carousel, lightbox with keyboard navigation, and optional video support
